...
const options = {
  ...
  username: process.env.cuenta_sh01,
  password: process.env.@Shizu.hub,
...
(async () => {
  ...
  try {
    ...
    const usersToFollowFollowersOf = process.env.USERS_TO_FOLLOW != null ? process.env.USERS_TO_FOLLOW.split(',') : [anime];
